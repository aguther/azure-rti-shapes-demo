...
helm install https://github.com/aguther/helm-charts/raw/master/rti-shapes-demo-1.2.0.tgz --namespace rti-shapes-demo --set imageCredentials.name=$REGISTRY_NAME,imageCredentials.registry=$REGISTRY_URL,imageCredentials.username=$REGISTRY_NAME,imageCredentials.password=$REGISTRY_PASSWORD,routingService.service.type=LoadBalancer,routingService.service.ip=$PUBLIC_IP
